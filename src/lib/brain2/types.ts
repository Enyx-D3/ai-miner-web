...
export type SyncPeerRecord = { id:string; deviceId:string; peerDeviceId:string; memoryRoot:string; name?:string; kind?:string; status:"DISCONNECTED"|"SIGNALING"|"CONNECTED"|"SYNCING"|"SYNCED"|"CONFLICT"|"ERROR"; lastSeenAt?:string; lastSyncAt?:string; lastPushedSequence:number; lastAppliedPeerSequence:number; pendingDeltas:number; transport:"WEBRTC"|"HTTPS"|"B2_NETWORK"; lastManifestHash?:string; error?:string; syncStage?:"IDLE"|"SIGNALING"|"CONNECTED"|"VERIFYING_MEMORY"|"MEMORY_CONFLICT"|"BOOTSTRAPPING"|"SYNCING_DELTAS"|"VERIFYING_CONVERGENCE"|"SYNCED"|"DISCONNECTED"|"ERROR"; transferDirection?:"SENDING"|"RECEIVING"; transferTable?:string; transferAppliedRecords?:number; transferTotalRecords?:number; transferAppliedBytes?:number; };
